$(function() {
    $("#hot_topic_scroll").slimScroll({
        width: '250px', //容器宽度,默认无
        height: '378px', //容器高度,默认250px
        size: '5px', //滚动条宽度,默认7px
        // position: 'left', //滚动条位置,可选值:left,right,默认right
        color: '#808080', //滚动条颜色,默认#000000
        ...
        railColor: '#d6d6d6', //滚动条背景轨迹颜色,默认#333333
